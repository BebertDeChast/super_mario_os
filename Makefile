...
CPPFLAGS  = -gdwarf-2 -g3 -Wall -fno-builtin -fno-rtti -fno-exceptions -fno-threadsafe-statics -nostdinc $($(COMPILATEUR_OPTION))
...
thread sched TestAndSet Mutex Spinlock Semaphore Hello Prod Cons Threads InfiniteHello pci vga EcranBochs sprite Movement Logic Keyboard GameDisplay MobLogic
...
run_gui: $(KERNEL_OBJ)
	$(QEMU) -net nic,model=ne2k_isa -net user,tftp=./build/boot -cdrom ./build/boot/grub.iso -serial stdio
